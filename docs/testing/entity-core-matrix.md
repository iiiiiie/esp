...
| LogicMod pak SHA-256 | `710FD094FE0B42AC045498EB0FBF0B087F27229F9BFD66982ED6184BE74A95E3`; tabbed filters, dimensional IV thresholds, and capped passive AND-filter checkpoint |
...
| AT-21 | LogicMod package | Generated package contains exactly six `.uasset` and six `.uexp` files with no runtime DLL | Pass | Clean Cook produced 12 files with no Cook/Blueprint errors; UnrealPak lists 12 files, 0 DLL, SHA-256 `710FD094FE0B42AC045498EB0FBF0B087F27229F9BFD66982ED6184BE74A95E3` |
...
| AT-38 | Tabbed filter panel | 1180x680 panel uses three tabs, expandable passive groups, and working clear-passive/clear-all actions | Pass | C++ plugin compiles; repeated Blueprint generation compiles Panel status 3 with 1388 nodes; clean Cook and package checks pass |
...
| EC-21 | Passive-skill display and filtering | Display uses localized names; no selection shows all; multiple selected skills use AND; hover shows localized effects | Pending | Typed providers, game-driven catalog, tooltip, same-order ID storage, Blueprint compile, Cook, and package contracts pass. |
