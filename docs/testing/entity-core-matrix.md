...
| AT-21 | LogicMod package | Generated package contains exactly eight `.uasset` and eight `.uexp` files with no runtime DLL | Pass | Clean Cook produced 16 files with no Cook/Blueprint errors; UnrealPak lists 16 files, 0 DLL, SHA-256 `26F84258914998E3DE556DDC6BE72B247E358F4FE65D4C3FCCBB40AD277404A8` |
