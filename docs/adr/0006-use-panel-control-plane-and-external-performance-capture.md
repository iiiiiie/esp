...
- Passive skills are grouped by game rank and lottery metadata into Rainbow, Legend/exclusive, Gold, Normal, and three negative tiers. Hover tooltips use the game's localized effect description. Clear-passive and clear-all actions update both the Blueprint-owned filter state and visible controls.
