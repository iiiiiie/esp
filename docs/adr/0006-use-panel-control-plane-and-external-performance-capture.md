...
Add a dedicated `WBP_ESPPanel` controlled by `Shift+E` and keep it separate from the per-frame overlay.
...
- [ ] Validate Shift+E input ownership and restoration in Steam single-player.
